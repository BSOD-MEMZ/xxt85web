...
var XSOFT_VIDEOS = [
  ...
  },
  {
    ...
    downloads: [
      { label: "在哔哩哔哩上观看", url: "https://www.bilibili.com/video/BV1WC8WzKERt/", icon: "assets/bilibili.png" }
    ],
  ...
  },
  {
    ...
    date: "9/30/25",
    mediaType: "MP4 视频",
    hidden: true, // 已删除的视频：数据保留，媒体库和搜索中不展示
    tags: ["其它"],
  ...
  },
  {
    ...
    type: "video",
    src: "file/《世界奇观》.mp4",
    poster: "cover/《世界奇观》.jpg",
    duration: "00:40",
    author: "@Kingstar",
    date: "8/4/26",
    mediaType: "MP4 视频",
    tags: ["其它"],
    description: '本视频记录了古代世界著名的日本文明在城市规划与设计上的杰出成就与其在众多文明之中的脱颖而出与大获全胜（站长注：其实那天是Kingstar和我以及来自中原一群伙伴去长沙玩，然后他们玩一些意义不明的桌游）',
    downloads: [],
    downloadNote: "目前暂无更高清的源文件"
  }
];
